  ...
  return (
    <div className="min-h-screen bg-surface flex items-start justify-center px-4 pt-8 md:pt-20 pb-12">
      <div className="w-full max-w-md bg-card rounded-xl border border-border shadow-sm p-8">
        ...
        <h1 className="text-2xl font-bold text-navy text-center mb-8">Welcome back</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <div className="flex items-center justify-between mb-1">
              ...
              <Link to="/reset-password" className="text-xs text-sky hover:underline">
                Forgot password?
              </Link>
            </div>
        ...
        <p className="text-center text-sm text-muted-foreground mt-6">
          ...
          <Link to="/signup" className="text-sky font-medium hover:underline">Sign up</Link>
        </p>
      </div>
    </div>
  );
